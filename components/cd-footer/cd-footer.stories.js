...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Canonical OCHA footer — the single source of truth, synthesized from reliefweb.int (dark), unocha.org (light) and humanitarianaction.info (sub-brand colour). The **structure is fixed**; the **background is theming**. Add one modifier class to `.cd-footer` — `--dark`, `--ocha`, `--hnrp`, `--flash`, `--gho` — and pair the matching logo (white on dark/colour, blue on light). The OCHA logo appears once.',
      },
    },
  },
};

const LOGO_BLUE = 'ocha-logo-horizontal-blue.svg';
const LOGO_WHITE = 'ocha-logo-horizontal-white.svg';
...
const socialLinks = `
  <ul class="cd-footer-social__list">
    ${social('X', '<path d="M18.244 2H21l-6.52 7.45L22 22h-6.79l-4.74-6.2L4.8 22H2l7.04-8.04L2 2h6.91l4.29 5.7L18.244 2Zm-1.19 18h1.6L7.05 4H5.34l11.71 16Z"/>')}
...
const services = `
  <div class="cd-footer__services">
    <h2 class="cd-footer__services-heading">OCHA services and related platforms</h2>
    <div class="cd-footer__services-cols">
      <a href="#">Central Emergency Response Fund</a>
      <a href="#">Financial Tracking Service</a>
      <a href="#">Humanitarian Data Exchange</a>
      <a href="#">Humanitarian Action</a>
      <a href="#">ReliefWeb</a>
      <a href="#">Inter-Agency Standing Committee</a>
      <a href="#">Pooled Funds Data Hub</a>
      <a href="#">Virtual OSOCC</a>
    </div>
  </div>`;

const mandate = (logo) => `
  <div class="cd-mandate">
    <a href="https://www.unocha.org" class="cd-mandate__logo" aria-label="OCHA home">
      <img src="${logo}" alt="OCHA" />
    </a>
...
const copyright = `
  <div class="cd-footer-copyright">
    <p class="cd-footer-copyright__text">OCHA &copy; ${new Date().getFullYear()} &middot; <a href="#">unocha.org</a></p>
  </div>`;

const buildFooter = ({ theme = '', logo = LOGO_BLUE, withServices = true } = {}) => `
  <footer class="cd-footer${theme ? ' cd-footer--' + theme : ''}">
    ...
    <div class="cd-footer__bottom">
      <div class="cd-footer__bottom-inner">
        ${mandate(logo)}
        ${copyright}
      </div>
    </div>
...
export const Default = () => buildFooter({});
Default.parameters = { docs: { description: { story: 'Light theme (default) — grey surface, dark text, blue logo. The neutral baseline for any OCHA product.' } } };

export const Dark = () => buildFooter({ theme: 'dark', logo: LOGO_WHITE });
Dark.parameters = { docs: { description: { story: 'Dark theme (`.cd-footer--dark`) — the reliefweb.int treatment. Navy surface, white text, white logo.' } } };

export const BrandedOCHABlue = () => buildFooter({ theme: 'ocha', logo: LOGO_WHITE });
BrandedOCHABlue.parameters = { docs: { description: { story: 'Sub-brand theme (`.cd-footer--ocha`). Use a sub-brand background only when the whole product is in that sub-brand (OCHA / HNRP / Flash / GHO).' } } };

export const BrandedGHO = () => buildFooter({ theme: 'gho', logo: LOGO_BLUE });
BrandedGHO.parameters = { docs: { description: { story: 'Sub-brand theme (`.cd-footer--gho`) — GHO yellow needs dark text and the blue logo for contrast.' } } };

export const Minimal = () => `
  <footer class="cd-footer">
    <div class="cd-footer__bottom" style="border-top: 0;">
      <div class="cd-footer__bottom-inner">
        ${mandate(LOGO_BLUE)}
        ${copyright}
      </div>
...
Minimal.parameters = { docs: { description: { story: 'Minimal — provider mandate and copyright only, for compact pages and apps.' } } };
